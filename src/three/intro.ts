...
/**
 * Stars, motion streaks, and the environmental shimmer are ON (per
 * Chris, 2026-09-23): "you can add the starts and environmental
 * shimmers back in". Set to false to park them again. Nothing was
 * deleted.
 */
 ...
 * this build. Stars/streaks/shimmer are on; story text stays parked
